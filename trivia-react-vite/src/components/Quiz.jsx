...
export default function Quiz() {
  ...
  const handleAnswerClick = (index) => {
    ...
    const esCorrecta = preguntas[currentQuestionIndex]?.correctAnswer === index;
  ...
  if (preguntas.length === 0) return <p style={{textAlign: "center", marginTop: "20px"}}>Cargando trivia...</p>;
            ...
            return (
              <button 
                ...
                style={{
                  ...
                  fontWeight: respuestaSeleccionada === index ? "bold" : "normal",
                  boxShadow: respuestaSeleccionada === index ? "0 4px 8px rgba(0,0,0,0.2)" : "none"
                }}
              >
                {option}
              </button>
